var ae=(H,G,w)=>new Promise((x,E)=>{var v=p=>{try{n(w.next(p))}catch(o){E(o)}},k=p=>{try{n(w.throw(p))}catch(o){E(o)}},n=p=>p.done?x(p.value):Promise.resolve(p.value).then(v,k);n((w=w.apply(H,G)).next())});import{d as de,w as V,j as $e,U as A,V as h,a2 as S,a0 as le,a1 as i,_ as e,$ as f,a5 as oe,k as a,u as y,a7 as X,W as M,a8 as se,a3 as J,f as u,c as D,n as ie,G as t,F as K,a4 as U,a6 as De}from"./vendor-vue-jNIXm5rS.js";import{G as ze}from"./GuideLayout-CQwLNe0V.js";import{C as z}from"./CodePreviewer-r_DN729B.js";import{K as ce,L as Ae,N as Ge,O as Te,H as Me,G as Ne}from"./vendor-antd-BTexbT_2.js";import{_ as ue}from"./index-Ns59gi1n.js";import"./FlowDesignerTest-ApZN45Qd.js";import"./vendor-x6-DeEwnSOW.js";const Fe={class:"code-drawer__header"},He={class:"code-drawer__header-left"},Oe={class:"code-drawer__title"},Re={class:"code-drawer__header-actions"},We={class:"code-drawer__font-size-label"},Pe={key:0,class:"code-drawer__search-bar"},Be={class:"code-drawer__search-count"},Ie={class:"code-drawer__pre"},je=["innerHTML"],Ve=10,Xe=24,Ke=de({__name:"CodeDrawer",props:{visible:{type:Boolean,default:!1},code:{default:""},language:{default:"text"},title:{default:"代码示例"},width:{default:600},showLineNumbers:{type:Boolean,default:!0}},emits:["update:visible","close"],setup(H,{expose:G,emit:w}){const x=H,E=w,v=u(!1),k=u(""),n=u("text"),p=u("代码示例"),o=u(600),g=u(!1),L=u(!0),C=u("idle"),$=u(!1),m=u(""),d=u([]),b=u(0),Y=u(),Z=u(),_=u(13),pe=u(.8),q=D(()=>k.value||x.code||""),O=D(()=>n.value||x.language||"text"),P=D(()=>{try{const r=O.value.toLowerCase(),c=q.value;if(r==="json"){const l=JSON.parse(c);return JSON.stringify(l,null,2)}return c}catch(r){return q.value}}),fe=D(()=>{const c=P.value.split(`
